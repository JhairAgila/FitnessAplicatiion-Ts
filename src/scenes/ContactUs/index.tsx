    ...
    <section id='contactus' className='mx-auto w-5/6 pt-24 pb-32 '>
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            >
                ...
                <p className="my-5">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Inventore accusamus beatae blanditiis,
                    minima sequi ea delectus voluptate vero nam et?
                </p>
            </motion.div>
            {/**FORM AND IMAGE  */}
            <div className='mt-10 justify-between gap-8 md:flex'>
                ...
                >
                    <form
                        target='_blank'
                        onSubmit={onSubmit}
                        action='https://formsubmit.co/a2a5739cc855038f4cc14ed52249c780'
                        method='POST' 
                    >
                        ...
                        {errors.message && (
                            ...
                            <button 
                                type='submit'
                                className='mt-5 bg-secondary-500 px-20 py-3 transition duration-500 hover:text-white '
                            >
                                SUBMIT
                            </button>
